...
// Google sign-in uses useAuth hook; Phone uses PhoneAuthModal internally
          ...
          <div className="p-5 flex flex-col gap-4 flex-1 min-h-0">
            ...
            <div className="space-y-2 flex-shrink-0">
              ...
              <div className="flex items-center gap-3 my-1">
                ...
                <span className="text-[10px] text-foreground/50 uppercase tracking-wider">or sign in</span>
                <div className="flex-1 h-px bg-white/30" />
              </div>
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  className="flex-1 h-11 rounded-2xl bg-white/20 backdrop-blur-sm border-white/30 text-foreground hover:bg-white/30 text-sm"
